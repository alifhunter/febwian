import svgPaths from "./svg-6tewr6ul4p";
...
function ContentWorks() {
  return (
    <div className="absolute box-border content-stretch flex flex-col gap-[48px] h-[923px] items-start justify-center left-0 pl-[50px] pr-0 py-0 top-1/2 translate-y-[-50%] w-[876px]" data-name="Content Works">
      <Project4 />
      <Project3 />
      <Project1 />
      <Project2 />
...
function Links() {
  return (
    <div className="content-stretch flex flex-col font-['Inter:Extra_Light',_sans-serif] font-extralight gap-[8px] items-start leading-[1.5] not-italic relative shrink-0 text-[24px] text-white underline" data-name="Links">
...
function ContentAbout() {
  return (
    <div className="bg-[#111216] box-border content-stretch flex flex-col gap-[40px] items-start pl-[50px] pr-0 py-0 relative w-[876px]" data-name="Content About">
      ...
      <p className="font-['Inter:Extra_Light',_sans-serif] font-extralight leading-[1.5] min-w-full not-italic relative shrink-0 text-[24px] text-white w-[min-content]">I’m a product designer for Bank Sinarmas’ internal tools and design system. I don’t like problems, but life’s full of them, so we face them head on by thinking, adapting, and refusing to quit.</p>
      <Links />
    </div>
  );
}
...
function Left() {
  return (
    <div className="absolute h-[923px] left-[51px] overflow-clip top-[50px] w-[876px]" data-name="Left">
      <ContentWorks />
      <div className="absolute flex h-[calc(1px*((var(--transform-inner-width)*0.2291473001241684)+(var(--transform-inner-height)*0.9733917713165283)))] items-center justify-center left-[-152px] top-[calc(50%-850.443px)] translate-y-[-50%] w-[calc(1px*((var(--transform-inner-height)*0.2291473001241684)+(var(--transform-inner-width)*0.9733917713165283)))]" style={{ "--transform-inner-width": "876", "--transform-inner-height": "576.5" } as React.CSSProperties}>
        <div className="flex-none rotate-[346.753deg]">
          <ContentAbout />
        </div>
      </div>
    </div>
...
function Works() {
  return (
    <div className="content-stretch flex gap-[28px] items-center relative shrink-0" data-name="Works">
      <p className="font-['Inter:Light',_sans-serif] font-light leading-[1.5] not-italic relative shrink-0 text-[48px] text-nowrap text-white whitespace-pre">Works</p>
      <Identifier />
    </div>
  );
}
...
function Content() {
  return (
    <div className="absolute box-border content-stretch flex flex-col gap-[45px] items-end justify-center left-0 pl-0 pr-[50px] py-0 top-[320px] w-[412px]" data-name="Content">
      <p className="font-['Inter:Extra_Light',_sans-serif] font-extralight leading-[1.5] not-italic relative shrink-0 text-[#aaaaaa] text-[32px] text-nowrap whitespace-pre">About</p>
      <Works />
...
export default function Desktop() {
  return (
    <div className="bg-[#111216] relative size-full" data-name="Desktop - 2">
